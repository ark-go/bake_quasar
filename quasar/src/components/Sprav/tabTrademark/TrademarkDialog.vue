  ...
  >
    <q-card class="ark-card">
      ...
      <div style="padding: 6px">
        ...
        <Trademark-Select
          :sprav="sprav.brand"
          v-model:select-id="computedSprav"
        >
        </Trademark-Select>
      </div>
      <q-separator />
...
export default {
  props: {
    ...
    sprav: {
      type: Object,
      default: () => {},
    }, // списки таблиц тут на надо brand_name
  ...
  setup(props, { emit }) {
    ...
    const selectId = ref("");
    function preDialog() {
      console.log("XXXXXXXXXXXXX33333", props.rowData, props.sprav);
