 ...
 * @returns
 */
export async function bakeryBaker(req, res) {
  ...
  switch (req.body.cmd) {
    ...
    case "addToGroup":
      ...
      return await addToGroup(req, res, "bakery_x_users_baker", timezone);
    case "moveToGroup":
      // Перенос территорию к печке
      return await addToGroup(req, res, "bakery_x_users_baker", timezone);
    case "info":
      // Перенос территорию к печке
      return await info(req, res, "bakery_x_users_baker", timezone);
    case "removeFromGroup":
      //   // Перенос территорию к печке
      return await removeFromGroup(req, res, "bakery_x_users_baker", timezone);
