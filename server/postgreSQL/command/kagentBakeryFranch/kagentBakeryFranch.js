 ...
 * @returns
 */
export async function kagentBakeryFranch(req, res) {
  ...
  switch (req.body.cmd) {
    ...
    case "addToGroup":
      ...
      return await addToGroup(req, res, "kagent_x_bakery_franch", timezone);
    case "moveToGroup":
      // Перенос территорию к печке
      return await addToGroup(req, res, "kagent_x_bakery_franch", timezone);
    case "info":
      // Перенос территорию к печке
      return await info(req, res, "kagent_x_bakery_franch", timezone);
    case "removeFromGroup":
      //   // Перенос территорию к печке
      return await removeFromGroup(
        req,
        res,
        "kagent_x_bakery_franch",
        timezone
      );
