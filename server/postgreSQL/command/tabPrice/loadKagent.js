...
export async function loadKagent(req, res, tabname, timezone, idOne) {
  ...
  let sqlP = {
    ...
    select 
      ...
      from (
        select parent_id,count(child_id) as count from kagent_x_bakery_get_kagent_ondate($1 AT TIME ZONE $2)
