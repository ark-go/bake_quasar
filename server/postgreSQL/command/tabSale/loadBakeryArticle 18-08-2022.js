...
--	price.id as price_id
  ...
  RIGHT JOIN (
	     ...
	     LEFT JOIN price prc on prc.id = pv.price_id
  ...
  LEFT JOIN price_value_hidden prvh ON prvh.price_value_id = prv.id AND prvh.bakery_id = bakery.id
	...
	--
  where price_bakery.bakery_id = $1 AND price.trademark_id = $2 -- and NOT prvh.hidden  IS true
...
`,
    values: [
      ...
      req.body.dateBetween.to || new Date(),
      timezone,
    ], // timezone
  };
