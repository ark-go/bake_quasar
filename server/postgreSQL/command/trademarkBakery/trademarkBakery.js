 ...
 * @returns
 */
export async function trademarkBakery(req, res) {
  ...
  switch (req.body.cmd) {
    ...
    case "addToGroup":
      ...
      return await addToGroup(req, res, "trademark_x_bakery", timezone);
    case "moveToGroup":
      // Перенос территорию к печке
      return await addToGroup(req, res, "trademark_x_bakery", timezone);
    case "info":
      // Перенос территорию к печке
      return await info(req, res, "trademark_x_bakery", timezone);
    case "removeFromGroup":
      //   // Перенос территорию к печке
      return await removeFromGroup(req, res, "trademark_x_bakery", timezone);
